    ...
    <main class="main-content">
        <div class="auth-zone full">
            ...
            <form method="post" action="mailto:admin@example.com" class="form" enctype="text/plain">
                ...
                <textarea name="message" placeholder="Votre message" required rows="5" style="resize: none; padding: 10px; border-radius: 8px; border: 1px solid #CCC; font-size: 16px;"></textarea>
